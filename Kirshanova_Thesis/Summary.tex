...
\begin{figure}[h]
		...
		\centering
		\begin{tikzpicture}
				    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.60\textwidth]{../Plots_SingleExp_PolySamples.png}};
		...
		\vspace*{20pt}
		\begin{tikzpicture}
				    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.59\textwidth]{../Plots_SingleExp_ExpSamples.png}};
				    \begin{scope}[x={(image.south east)},y={(image.north west)}]
